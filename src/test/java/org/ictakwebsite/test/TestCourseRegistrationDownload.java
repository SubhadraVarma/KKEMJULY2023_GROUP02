...
import org.ictakwebsite.pages.CourseRegistrationDownload;
...
public class TestCourseRegistrationDownload extends TestBase{
...
final String expectedFinalName="ExcelSheet.xlsx";
	...
	public void downloadTest() throws InterruptedException
	{
    	...
    	ClassObjects.courseregistrationdownload=new CourseRegistrationDownload(driver);
		ClassObjects.courseregistrationdownload.course_reg_click();
		ClassObjects.courseregistrationdownload.click_download();
		Thread.sleep(1000);
